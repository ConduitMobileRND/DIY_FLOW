...
render() {
        let bgImage = {backgroundImage: "url(" + this.props.backgrounds.all[this.props.backgrounds.currentKey] + ")"};
        ...
        return(
            <div className={pageWrapClasses} style = {bgImage}>
               <div className="darkened">
                  <div className="logo">
                      <img src="images/como_logo_white.png" alt="Como Logo"/>
                  </div>
                     <div className="row text-center vAlign">
                       <div className="columns large-12">
                           ...
                           <form>
                               <div className="row collapse">
                                   <Input className="borderLeft" foundationClasses="large-5    -5 columns" ref= "store" name="store" stateId="store" placeholder="Store name" isValid={this.props.form.store.isValid} type="text" value={this.props.form.store.value} onChange={this.props.setData.bind(null, this.props.stateId)} onFocus={this._stopBgAnimation} onBlur={this.props.handleValidation.bind(null, this.props)} onKeyUp={this.props.handleValidation.bind(null, this.props)} errorMsg={this.props.form.errorMessages.store} isRequired='true' validType='text'/>
                                   <Input className="borderNone" foundationClasses="large-5 medium-5 columns" name="email" ref="email" stateId="email" placeholder = "Email" type="email" isValid={this.props.form.email.isValid} value={this.props.form.email.value} onChange={this.props.setData.bind(null, this.props.stateId)} onFocus={this._stopBgAnimation} onKeyUp={this.props.handleValidation.bind(null, this.props)} onBlur={this.props.handleValidation.bind(null, this.props)} errorMsg={this.props.form.errorMessages.email} isRequired='true' validType='email'/>
