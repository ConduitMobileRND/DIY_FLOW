...
export default class Step1 extends Component {
        ...
        this.state = {
            data: {
                ...
                payload: {
                    ...
                    businessName:{value:stored.store.value, isValid:true},
    ...
    _handleBtnClick(elem,event){
        ...
        if(engineReturnData.error || !engineReturnData.data.nextStepUri){
            alert("OOPS... We didn't get a next page, fallback needed here");return;
        }
    ...
    _onWrapperClick(e){
        console.log(jQuery("input[name='facebook']").val());
        if(e.target.name == "facebook" || e.target.className=="autoCompleteList" || this.state.data.chosenFromFbOptions){
            return;
        }
            ...
            <div id="step1" className="pageWrap" onClick={this._onWrapperClick}>
                <div className="row">
                    ...
                    <form>
                        ...
                        <div className="row">
                            <Button className="borderRight" foundationClasses="large-4 columns large-centered" buttonSize="large" btnText="NEXT" onClick={this._handleBtnClick}/>
                        </div>
                    </form>
            </div>
        )
